  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold text-gray-700">Reactivación Pro — este mes</h2>
        {revenue_recovered > 0 && (
...
function Metric({
  ...
  return (
    <div className={`rounded-xl p-3 text-center ${highlight ? 'bg-brand-50' : 'bg-gray-50'}`}>
      <p className={`text-2xl font-bold ${highlight ? 'text-brand-700' : muted ? 'text-gray-400' : 'text-gray-900'}`}>
        {value}
      </p>
